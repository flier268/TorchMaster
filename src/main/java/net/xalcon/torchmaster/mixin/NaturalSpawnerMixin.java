...
public abstract class NaturalSpawnerMixin
{
    ...
    private static boolean torchmaster_isValidPositionForMob_checkSpawnRules(Mob mob, LevelAccessor level, MobSpawnType spawnReason, Operation<Boolean> original)
    {
        return MobWrapper.checkSpawnRules(mob, level, spawnReason, original);
    }
    ...
    private static boolean torchmaster_spawnMobsForChunkGeneration_checkSpawnRules(Mob mob, LevelAccessor level, MobSpawnType spawnReason, Operation<Boolean> original)
    {
        return MobWrapper.checkSpawnRules(mob, level, spawnReason, original);
    }
}
