...
public abstract class BaseSpawnerMixin
{
    ...
    private static boolean torchmaster_serverTick_checkSpawnRules(Mob mob, LevelAccessor level, EntitySpawnReason spawnReason, Operation<Boolean> original)
    {
...
public abstract class BaseSpawnerMixin
{
    ...
    private static boolean torchmaster_serverTick_checkSpawnRules(Mob mob, LevelAccessor level, MobSpawnType spawnReason, Operation<Boolean> original)
    {
        return MobWrapper.checkSpawnRules(mob, level, spawnReason, original);
    }
}
