...
public abstract class NaturalSpawnerMixin
{
    ...
    private static boolean torchmaster_isValidPositionForMob_checkSpawnRules(Mob mob, LevelAccessor level, EntitySpawnReason mobSpawnType, Operation<Boolean> original)
    {
    ...
    private static boolean torchmaster_spawnMobsForChunkGeneration_checkSpawnRules(Mob mob, LevelAccessor level, EntitySpawnReason mobSpawnType, Operation<Boolean> original)
    {
        return MobWrapper.checkSpawnRules(mob, level, mobSpawnType, original);
    }
}